          ...
          <PrivateRoute path={pages.app.getPath()}>
            <pages.app.component>
              <Switch>
                ...
                <Route
                  exact
                  path={pages.app.news.getPath()}
                  component={pages.app.news.component}
                />

                <Route
                  exact
                  path={pages.app.support.getPath()}
                  component={pages.app.support.component}
                />

                <Route
                  exact
                  path={pages.app.withdrawal.getPath()}
                  component={pages.app.withdrawal.component}
                />
